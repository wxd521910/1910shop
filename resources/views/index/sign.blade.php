...
<body>
<form method="post" action="{{url('login/signAdd')}}">
    @csrf
    <dl class="admin_login">
        <dt>
            <strong>前台注册管理系统</strong>
        ...
        <dd class="user_icon">
            <input type="text" name="l_name" placeholder="请输入用户账号" class="login_txtbx"/>

        </dd>
        <dd class="pwd_icon">
            <input type="password" name="l_pwd" placeholder="请输入用户密码" class="login_txtbx"/>

        <dd class="pwd_icon">
            <input type="password" name="l_pwds" placeholder="请确定用户密码" class="login_txtbx"/>
